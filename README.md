...
| SCR-001 地点入力         | 住所 / 緯度経度・検索半径（100m〜3km）・確認カテゴリ選択、入力検証。**調査テンプレート（評価書 #21）**: 標準調査・道路工事・河川・護岸工事・建築・造成工事の工種別プリセットで半径・カテゴリの初期値を一括適用（適用後も個別調整可）。**最近の住所（評価書 #11）**: 実行した入力住所を localStorage に最大5件保存し、ワンクリックで再入力                                                                                                                                                                                                                                                                  |
